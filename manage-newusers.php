...
<title>Users Ready To Deploy</title>
...
<li class="active">Ready To Deploy</li>
</ol>
</div>
</div>
</div>
...
<strong class="card-title">Ready To Deploy</strong>
</div>
<div class="card-body">
<table class="table">
<thead>
...
<td ><a style="background-color:#2196F3; color: white;" href="view-user-detail.php?upid=<?php echo $row['ID'];?>">&nbspDeploy&nbsp  </a></td>
</tr>
<?php 
$cnt=$cnt+1;
}?>
