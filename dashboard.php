...
<p class="text-light">Total Users of Deployment</p>
...
<div class="dropdown-menu-content">
	<a class="dropdown-item" href="manage-device-user.php">Action</a>
	
</div>
</div>
</div>
<?php $query1=mysqli_query($con,"Select * from  tbldevices");
$totalcomp=mysqli_num_rows($query1);
?>
<h4 class="mb-0">
<span class="count"><?php echo $totalcomp;?></span>
</h4>
<p class="text-light">Total Devices With Users</p>
